...
> **Note:** Wistia OAuth2 is not available for all accounts. This integration uses custom authentication with an API token to ensure compatibility for all users.
---
